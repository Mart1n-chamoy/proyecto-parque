...
ROOT_URLCONF = 'proyecto_cobranza.urls'
...
WSGI_APPLICATION = 'proyecto_cobranza.wsgi.application'

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.environ.get('DB_NAME', 'cobranza_db'),
...
ELEVENLABS_WHATSAPP_PHONE_NUMBER_ID = os.environ.get('ELEVENLABS_WHATSAPP_PHONE_NUMBER_ID', '')
